...
public class Series extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final SerieAdapter adapterVideo = new SerieAdapter (this, R.layout.ligne);
                    ...
                    public void onResponse(JSONArray response){
                        ...
                        while (count < response.length()){
                            try{
                                ...
                                uneSerie.setTitre (jsonObject.getString("titreSerie"));
                                uneSerie.setRealisateur (jsonObject.getString("realisateur"));
